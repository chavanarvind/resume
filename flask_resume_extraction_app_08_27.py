...
class ResumeProcessor:
    ...
    def extract_information(self, resumes_text):
        ...
        for filename, text in resumes_text.items():
            ...
            Industry_sector is not directly mentioned in the resume, use your knowledge to decide it.
            Profile_Summary must be based on overall work-related experience and should not be more than one paragraph.
            '''
            ...
            print(f"Raw API response for file '{filename}': {repr(response_content)}")
            ...
            if response_content:
                ...
                print(f"Received an empty response for file '{filename}'")
...
app = Flask(__name__)
app.config['GROQ_API_KEY'] = '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'
